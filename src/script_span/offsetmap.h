...
#ifndef THIRD_PARTY_CLD_3_SRC_SCRIPT_SPAN_OFFSETMAP_H_
#define THIRD_PARTY_CLD_3_SRC_SCRIPT_SPAN_OFFSETMAP_H_

#include <string>                       // for string

#include "third_party/cld_3/src/script_span/integral_types.h"             // for uint32
